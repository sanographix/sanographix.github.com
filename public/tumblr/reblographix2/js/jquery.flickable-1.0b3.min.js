...
0)return h.extend({},this.options);if(typeof a==="string"){if(d===q)return this.options[a];c={};c[a]=d}h.each(c,function(e,g){b.setOption(e,g)});return this},setOption:function(a,d){var b=this,c=false;this.options[a]=d;switch(a){case "cancel":this.cancel&&this.cancel.removeClass("ui-flickable-canceled").unbind(".flickable");this.cancel=h("div",this.content).map(function(e,g){var f;f=g;f=h(f);f=h.inArray(f.css("overflow"),["scroll","auto"])>=0?f.prop('scrollWidth')>f.attr("clientWidth")||f.prop('scrollHeight')>
